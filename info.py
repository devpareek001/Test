...
API_ID = int(environ.get('API_ID', '6914788581'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002245108673').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002245108673'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002245108673'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002245108673'))  
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002245108673')) 
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002245108673') 
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002245108673') 
...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002189976586") # add multiple channels here, separated by single space
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '') # add multiple channels here, separated by single space

IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '1002245108673'))
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002245108673'))
